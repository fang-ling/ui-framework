 ...
 *
 * The value of this property is `yes` when the view is in memory or `no` when
 * it is not. Accessing this property does not attempt to load the view if it is
 * not currently in memory.
 */
@property (nonatomic, readonly) CBoolean isViewLoaded;
